        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 mb-24 md:mb-40 items-start">
          ...
          <div className="lg:w-1/2 flex flex-col w-full lg:pt-16">
            <div className="flex flex-col gap-12 lg:pl-12">
              ...
              {/* GENERAL TELEPHONE */}
              <div className="group flex flex-col">
                <span className="text-xs font-bold text-on-surface-variant uppercase tracking-[0.2em] mb-4 block">General Telephone</span>
                <a 
              ...
              <div className="flex flex-col mt-4 items-start">
                ...
                <p className="text-lg md:text-xl text-on-surface font-medium max-w-md mb-8">
                  Need to speak directly with our team?<br /><br />
                  Send us an email and let us know you'd like to speak directly with our manager. Our team will get back to you.
                </p>
                <a
                  href={`https://mail.google.com/mail/?view=cm&fs=1&to=${contactContent.details.email}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={cn(buttonVariants("crystal", "md"), "group")}
                  aria-label="Request Direct Contact"
                >
                  Request Direct Contact
                  <ArrowRight className="w-5 h-5 ml-2 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-x-1.5" />
                </a>
              </div>
